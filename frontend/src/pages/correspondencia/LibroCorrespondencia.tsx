...
const LibroCorrespondencia = () => {
  ...
  const handleFirmar = async ({ otp, firmaY, firmaPage, firmaCol, desatendida, firmaRect }: FirmaParams) => {
    if (!previewToken) return
    setFirmaLoading(true)
    setFirmaError(null)
    try {
      const res = await correspondenciaAPI.libroFirmar(previewToken, otp, firmaY, firmaPage, firmaCol, desatendida, firmaRect)
